...
<body class="hidden hidden-ball smooth-scroll uppercase-titles" data-primary-color="#8c6144">
    ...
    <main>
        <!-- Preloader -->
        <div class="preloader-wrap" data-centerLine="Chargement">
            <div class="outer">
                <div class="inner">
                    <div class="trackbar">
                    ...
                    <div class="percentage-intro">Veuillez patienter, le contenu est en cours de chargement</div>
                </div>
            </div>
        </div>
        <!--/Preloader -->
        ...
        <div class="cd-index cd-main-content">
            ...
            <div id="page-content" class="light-content"
                style="background-image:url(images/05hero.jpg);background-size: cover;">
                    ...
                    <div id="header-container">
                        ...
                        <div id="logo" class="hide-ball">
                            <a class="ajax-link" data-type="page-transition" href="index-2.html">
                                <img class="black-logo" src="images/logo.png" alt="Logo de Digital Box">
                                <img class="white-logo" src="images/logo-white.png" alt="Logo de Digital Box">
                            </a>
                        </div>
                        <!--/Logo -->
                                ...
                                <div id="hero-caption"
                                    ...
                                    <div class="inner">
                                        <h1 class="hero-title caption-timeline primary-font-title">
                                            <span><em>Découvrez</em> Digital Box</span></h1>
                                        <div class="hero-arrow link caption-timeline"><span><i
                                                    class="arrow-icon"></span></i></div>
                                    </div>
                                </div>
                                <div id="hero-description" class="content-max-width">
                                    <div class="inner">
                                        <p class="bigger">À propos de nous</p>
                                        <p class="has-opacity">Découvrez la puissance des solutions de conception web
                                            innovantes, fraîches et abordables proposées par Digital Box. Nos templates
                                            de portfolio créatifs offrent des possibilités infinies pour libérer votre
                                            créativité.</p>
                                        <br>
                                        <p class="bigger no-margins">Conception Web Abordable</p>
                                        <p class="has-opacity">Nous comprenons l'importance de l'accessibilité, c'est
                                            pourquoi nous proposons des services de conception web abordables sans
                                            compromettre la qualité.</p>
                                        <p class="bigger no-margins">Date</p>
                                        <p class="has-opacity">Juillet 2023</p>
                                        <p class="bigger no-margins">Services</p>
                                        <p class="has-opacity no-margins">Direction artistique, Conception web,
                                            Production</p>
                                        <hr>
                                        <p class="has-animation">[ <a class="link-text" target="_blank"
                                                href="https://www.digitalbox.com/">Visitez notre site web</a> ]</p>
                                    </div>
                                </div>
                                <div id="hero-footer">
                                    <div class="hero-footer-left">
                                        <div class="button-wrap right scroll-down">
                                            ...
                                            <div class="button-text sticky right"><span
                                                    data-hover="Défiler pour explorer">Défiler pour explorer</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="main-page-content">
                                ...
                                <div class="content-row row_padding_top row_padding_bottom light-section change-header-color"
                                    ...
                                    <div class="one_half last">
                                        <h3 class="has-mask-fill block-title">Nos Solutions de Conception Web</h3>
                                        <p class="has-opacity">Créez des solutions de conception web dynamiques et
                                            captivantes avec Digital Box. Nos templates de portfolio créatifs offrent
                                            une expérience de navigation immersive.</p>
                                ...
                                <div class="content-row row_padding_bottom light-section change-header-color"
                                    ...
                                    <div class="one_half">
                                        <h3 class="has-mask-fill block-title">Notre Direction</h3>
                                        <p class="has-opacity">Orientez-vous vers la droite ou la gauche en changeant
                                            dynamiquement une seule classe dans le shortcode.</p>
                                    </div>
                                ...
                                <div class="content-row row_padding_bottom light-section change-header-color"
                                    ...
                                    <div class="one_half last">
                                        <h3 class="has-mask-fill">Les Tailles</h3>
                                        <p class="has-opacity">Vous avez la flexibilité de définir une largeur fixe ou
                                            des tailles aléatoires, comme le montrent ces exemples.</p>
                                    </div>
                            ...
                            <div id="project-nav" class="">
                                <div class="next-project-wrap">
                                    ...
                                    <p class="all-works">[ <a class="link-text ajax-link" data-type="page-transition"
                                            href="index-showcase-carousel.html"><span class="link"
                                                data-hover="View All Works">View All Works</span></a> ]</p>

                                    <div class="next-project-caption text-align-center content-max-width">
                                        <div class="next-caption-wrapper">
                                            <div class="caption-wrapper">
                                                <a class="next-ajax-link-project auto-trigger"
                                                    data-type="page-transition" href="project01.html"
                                                    data-color="#963a8d" data-firstline="Next"
                                                    data-secondline="Project"></a>
                                                <div class="next-caption">
                                                    <div class="next-hero-counter"><span>0</span></div>
                                                    <div class="next-hero-title primary-font-title"><span><em>The</em>
                                                            Handbag</span></div>
                                    ...
                                    <div class="next-project-image-wrapper">
                                        <div class="next-project-image">
                                            <div class="next-project-image-bg"
                                                style="background-image:url(images/01hero.jpg)"></div>
                                        </div>
                                    </div>
                    ...
                    <footer class="hidden">
                        <div id="footer-container">
                            ...
                            <div id="backtotop" class="button-wrap left">
                                ...
                                <div class="button-text sticky left"><span data-hover="Haut de page">Haut de page</span>
                                </div>
                            </div>

                            <div class="footer-middle">
                                <div class="copyright">2023 © <a class="link" target="_blank"
                                        href="https://www.clapat.com/">Digital Box</a>. Tous droits réservés.</div>
                            </div>
                            ...
                            <div class="socials-wrap">
                                ...
                                <ul class="socials">
                                    <li><span class="parallax-wrap"><a class="parallax-element"
                                                href="https://www.dribbble.com/clapat" target="_blank">Db</a></span>
                                    </li>
                                    <li><span class="parallax-wrap"><a class="parallax-element"
                                                href="https://www.twitter.com/clapatdesign"
                                                target="_blank">Tw</a></span></li>
                                    <li><span class="parallax-wrap"><a class="parallax-element"
                                                href="https://www.behance.com/clapat" target="_blank">Be</a></span></li>
                                    <li><span class="parallax-wrap"><a class="parallax-element"
                                                href="https://www.facebook.com/clapat.ro" target="_blank">Fb</a></span>
                                    </li>
                                    <li><span class="parallax-wrap"><a class="parallax-element"
                                                href="https://www.instagram.com/clapat.themes/">Ig</a></span></li>
                                </ul>
                            </div>
